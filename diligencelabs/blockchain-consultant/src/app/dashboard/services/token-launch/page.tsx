...
const bookingSchema = z.object({
  ...
  launchType: z.enum(["ICO", "IDO", "IEO", "FAIR_LAUNCH", "AIRDROP", "PRIVATE_SALE", "OTHER"], {
    required_error: "Please select launch type",
  }),
  description: z.string().min(50, "Please provide detailed information (minimum 50 characters)"),
  launchTimeline: z.string().min(10, "Please specify launch timeline"),
  targetRaise: z.string().min(1, "Target raise amount is required"),
  launchPlatforms: z.string().min(10, "Please specify preferred launch platforms"),
  marketingStrategy: z.string().min(20, "Please describe marketing strategy"),
  legalCompliance: z.enum(["RESEARCH_PHASE", "IN_PROGRESS", "COMPLETED", "NOT_STARTED"], {
    required_error: "Please select legal compliance status",
  }),
  communitySize: z.string().min(1, "Community size information is required"),
...
const serviceDetails = {
  ...
  description: "Comprehensive token launch strategy, platform selection, compliance guidance, and go-to-market execution.",
  basePricePerHour: 450,
  color: "from-orange-500 to-red-500"
}

export default function TokenLaunchConsultation() {
  ...
  async function onSubmit(data: BookingForm) {
    ...
    try {
      ...
      if (!session) {
        const consultationData = { ...data, totalPrice, serviceType: "TOKEN_LAUNCH" }
      ...
      console.log("Processing Token Launch consultation payment for:", totalPrice, "USD")
          ...
          <CardContent className="pt-8 pb-8 text-center">
            <div className="space-y-6">
              ...
              <h2 className="text-3xl font-light mb-2">
                Token Launch <span className="font-normal bg-gradient-to-r from-green-400 to-emerald-400 bg-clip-text text-transparent">Consultation Booked</span>!
              </h2>
              ...
              {!showCalendly ? (
                <>
                  <p className="text-gray-400 text-lg mb-4">
                    {session 
                      ? `Payment of $${totalPrice} processed successfully! Your token launch consultation has been booked.`
                ...
                <div className="space-y-6">
                  <p className="text-gray-300 text-lg">
                    Now let's schedule your token launch consultation!
                  </p>
                  ...
                  <div className="bg-gradient-to-r from-orange-500/10 to-red-500/10 rounded-lg p-6 border border-orange-500/20">
                    ...
                    <p className="text-gray-400 text-sm mb-6">
                      Click the link below to choose a convenient time for your token launch consultation with our experts.
                    </p>
                    ...
                    <div className="space-y-4">
                      <Button asChild className="w-full bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white font-medium py-3 rounded-lg transition-all duration-300 hover:scale-105">
                        <a 
                          href="https://calendly.com/diligence-labs/token-launch" 
                          target="_blank" 
                          rel="noopener noreferrer"
                          className="flex items-center justify-center"
                        >
                          Schedule Launch Session
        ...
        <div className={`flex items-center gap-4 mb-12 transition-all duration-1000 ${isPageLoaded ? 'translate-y-0 opacity-100' : '-translate-y-10 opacity-0'}`}>
          ...
          <div>
            <h1 className="text-4xl font-light mb-2">
              <span className={`font-normal bg-gradient-to-r ${serviceDetails.color} bg-clip-text text-transparent`}>Token Launch</span> Consultation
            </h1>
            <p className="text-gray-400 text-lg">Comprehensive token launch strategy and execution guidance</p>
          </div>
        </div>
        ...
        <div className={`max-w-4xl mx-auto transition-all duration-1000 delay-300 ${isPageLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          <ProminentBorder className="rounded-3xl overflow-hidden shadow-2xl shadow-orange-500/10" animated={true}>
            ...
            <CardHeader className="text-center pb-8">
              <CardTitle className="text-3xl font-light text-white">Token Launch Details</CardTitle>
              <CardDescription className="text-gray-400 text-lg">
                Provide comprehensive information for token launch strategy and execution planning
              </CardDescription>
            </CardHeader>
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                    ...
                    <div className="bg-gradient-to-r from-orange-500/5 to-red-500/5 rounded-xl p-4 border border-orange-500/10">
                      <div className="text-center">
                        ...
                        <p className="text-sm text-gray-400 mb-3">
                          Token launch consultation with comprehensive strategy and execution guidance.
                        </p>
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-gray-400 text-sm">
                            Token Launch • {durationOptions.find(d => d.value === selectedDuration)?.label}
                          </p>
                        </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-gray-300 text-lg">Launch Type</FormLabel>
                          <Select onValueChange={field.onChange} defaultValue={field.value}>
                            ...
                            <SelectContent className="bg-gray-800 border-gray-700 text-white">
                              <SelectItem value="ICO" className="hover:bg-gray-700">ICO (Initial Coin Offering)</SelectItem>
                              <SelectItem value="IDO" className="hover:bg-gray-700">IDO (Initial DEX Offering)</SelectItem>
                              <SelectItem value="IEO" className="hover:bg-gray-700">IEO (Initial Exchange Offering)</SelectItem>
                              <SelectItem value="FAIR_LAUNCH" className="hover:bg-gray-700">Fair Launch</SelectItem>
                              <SelectItem value="AIRDROP" className="hover:bg-gray-700">Airdrop Campaign</SelectItem>
                              <SelectItem value="PRIVATE_SALE" className="hover:bg-gray-700">Private Sale</SelectItem>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-gray-300 text-lg">Target Raise</FormLabel>
                          <FormControl>
                            <Input 
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-gray-300 text-lg">Launch Timeline</FormLabel>
                          <FormControl>
                            <Input 
                              placeholder="e.g., Q2 2025, 3 months, ASAP" 
                              {...field} 
                              disabled={isLoading}
                              className="bg-gray-800/50 border-gray-600 text-white placeholder-gray-400 focus:border-orange-500 h-12"
                            />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-gray-300 text-lg">Community Size</FormLabel>
                          <FormControl>
                            <Input 
                              placeholder="e.g., 10K Discord, 50K Twitter" 
                              {...field} 
                              disabled={isLoading}
                              className="bg-gray-800/50 border-gray-600 text-white placeholder-gray-400 focus:border-orange-500 h-12"
                            />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-gray-300 text-lg">Legal Compliance Status</FormLabel>
                          <Select onValueChange={field.onChange} defaultValue={field.value}>
                            <FormControl>
                              <SelectTrigger className="bg-gray-800/50 border-gray-600 text-white h-12">
                            ...
                            <SelectContent className="bg-gray-800 border-gray-700 text-white">
                              <SelectItem value="NOT_STARTED" className="hover:bg-gray-700">Not Started</SelectItem>
                              <SelectItem value="RESEARCH_PHASE" className="hover:bg-gray-700">Research Phase</SelectItem>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea 
                            placeholder="Provide detailed information about your project, including the problem it solves, target audience, competitive advantages, and current development status..."
                        ...
                        <FormDescription className="text-gray-500">
                          Include project stage, team background, and unique value proposition
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-gray-300 text-lg">Preferred Launch Platforms</FormLabel>
                        <FormControl>
                          <Textarea 
                            placeholder="Specify preferred launch platforms - Uniswap, PancakeSwap, Binance Launchpad, Coinlist, Polkastarter, specific CEX or DEX platforms..."
                        ...
                        <FormDescription className="text-gray-500">
                          Include both centralized and decentralized platforms
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-gray-300 text-lg">Marketing Strategy</FormLabel>
                        <FormControl>
                          <Textarea 
                            placeholder="Describe your current marketing approach, partnerships, influencer relationships, PR plans, community building strategies, and budget allocation..."
                            className="bg-gray-800/50 border-gray-600 text-white placeholder-gray-400 focus:border-orange-500 min-h-[100px]"
                            {...field}
                            disabled={isLoading}
                          />
                        ...
                        <FormDescription className="text-gray-500">
                          Include current efforts and planned initiatives
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-300 leading-relaxed">
                          This token launch consultation requires upfront payment of <strong>${totalPrice || '---'}</strong> to secure your session. 
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 pt-8">
                    <Button 
                      ...
                      className="flex-1 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 disabled:from-gray-500 disabled:to-gray-600 disabled:opacity-50 text-white font-medium py-4 text-lg rounded-lg transition-all duration-300 hover:scale-105 flex items-center justify-center gap-2"
                    >
                      {isLoading ? (
                        <>
