  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 text-white hover:bg-gray-700 rounded-md transition-colors"
        ),
        ...
        day_outside:
          "day-outside text-gray-500 opacity-50 aria-selected:bg-gray-900/50 aria-selected:text-gray-500 aria-selected:opacity-30",
